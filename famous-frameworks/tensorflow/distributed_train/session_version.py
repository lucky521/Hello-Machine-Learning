...
os.environ['TF_CONFIG'] = json.dumps({
    'cluster': {'worker': ["11.7.157.235:12345", "10.181.203.174:23456"], 'ps' : ["11.25.198.16:34567"]},
...
tf.compat.v1.flags.DEFINE_float('learning_rate', 0.00003, 'Initial learning rate.')
tf.compat.v1.flags.DEFINE_integer('steps_to_validate', 1000, 'Steps to validate and print loss')

# For distributed
tf.compat.v1.flags.DEFINE_integer("issync", 1, "是否采用分布式的同步模式，1表示同步模式，0表示异步模式")
