...
class SignatureDefMap :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.SignatureDefMap) */ {
 public:
  SignatureDefMap();
...
class GetModelMetadataRequest :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.GetModelMetadataRequest) */ {
 public:
...
class GetModelMetadataResponse :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.GetModelMetadataResponse) */ {
 public:
