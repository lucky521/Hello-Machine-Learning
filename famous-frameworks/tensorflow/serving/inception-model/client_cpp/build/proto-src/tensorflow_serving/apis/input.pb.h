...
class ExampleList :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.ExampleList) */ {
 public:
  ExampleList();
  virtual ~ExampleList();
...
class ExampleListWithContext :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.ExampleListWithContext) */ {
 public:
...
class Input :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.Input) */ {
 public:
  Input();
  virtual ~Input();
